...
3. Configure the device by following the initial setup procedure：/docs/devices/wifi-halow/ht-h7608/usage-guide
...
Once the device has rebooted and started successfully (indicated by the red light turning off), immediately enter Configuration Mode (refer to [this document](/docs/devices/wifi-halow/ht-h7608/usage-guide) for instructions). After entering Configuration Mode, follow the steps below to configure the device:
