...
• Launch an on-site installation of solar-powered mesh nodes for a North American forestry monitoring project;
 • Initiate European channel development and engage local system integrators and IoT service providers to scale deployments;
 • Roll out an upgraded edge LoRa gateway with 5G backhaul support and further low-power optimizations for mesh nodes to better serve unmanned, complex-terrain scenarios.
